<!--**********************************
    ...
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li class="mm-active"><a class="" href="<?php echo base_url('/empathy'); ?>" aria-expanded="false">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 col-xxl-12">
                <div class="card">
                    <div class="card-header bg-info d-flex justify-content-between align-items-center py-4 px-4">
                        <h4 class="card-title text-white">Service Quality Stats</h4>
            ...
            <i class="fa fa-chevron-down pull-right"></i>
                    ...
                    <div class="card-body d-flex justify-content-center align-items-center">
							<canvas id="emq_bar" style="width:100%;"></canvas>
					    </div>
                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <div class="form-group row">
                                                                    <input type="hidden" id="qgroup" value="2">
