                    ...
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12 d-flex justify-content-center align-items-center">
                                ...
                                <video id="videoElement" autoplay playsinline style="width:540px;height:375px;border:1px solid blue;">
                        ...
                        <div class="text-center mb-4">
                            <button type="button" id="save_images" disabled class="btn btn-info btn-md">Save Images</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                                ...
                                <div class="auth-form">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input id="fname" type="text" class="form-control" placeholder="Fullname">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="yrsec" class="form-control" placeholder="Year and Section">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="button" id="save_info" class="btn btn-primary btn-block">Save Info</button>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="img-box" class="d-flex justify-content-evenly align-items-center">
