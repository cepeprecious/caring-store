...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li class="mm-active"><a class="" href="<?php echo base_url('client_dashboard'); ?>" aria-expanded="false">
                    ...
                    <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List of MRs</h4>
                            </div>
                            <div class="card-body">
