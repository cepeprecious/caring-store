        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="<?php echo base_url('c_returned'); ?>">Returned</a></li>
                    <li class="active"><a href="<?php echo base_url('c_transfer'); ?>">Transfered</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tbl_ctransfer" class="display" style="min-width: 845px">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Qty</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Computer Set</td>
                                        <td>Computer</td>
                                        <td>OCVC-SERIAL-2022</td>
                                        <td>52000</td>
                                        <td><span class="badge badge-info">Transferred</span></td>
                                        <td>Mary Smith</td>
                                        <td>April 22, 2022</td>
                                        <td>
                                            <div class="d-flex">
                                                <button type="button" class="btn  btn-info shadow btn-xs sharp mr-1"><i class="fa fa-search"></i></button>
